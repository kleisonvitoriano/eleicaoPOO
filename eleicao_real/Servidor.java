...
public class Servidor extends Pessoa {
    ...
    public Servidor(String nome, String cpf, int matricula, LocalDate dataNascimento, String campus,
            eleicao_real.Titulacao titulacao, LocalDate inicio_carreira, boolean efetivo, String responsavel) {
    ...
    public Servidor(String nome, String cpf, int matricula, LocalDate dataNascimento, String campus,
            eleicao_real.Titulacao titulacao, LocalDate inicio_carreira, boolean efetivo) {
        super(nome, cpf, matricula, dataNascimento);
        this.setCampus(campus);
        this.setTitulacao(titulacao);
        this.setinicio_carreira(inicio_carreira);
