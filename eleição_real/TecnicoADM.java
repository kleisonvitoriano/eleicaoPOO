...
public class TecnicoADM extends Servidor {
   ...
   public TecnicoADM(String nome, String cpf, int matricula, LocalDate dataNascimento, String campus, Titulacao titulacao, boolean efetivo, int tempoEfetivoServico, LocalDate tempoCargoGestao) {
